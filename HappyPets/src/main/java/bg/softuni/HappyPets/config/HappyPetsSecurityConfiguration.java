package bg.softuni.HappyPets.config;
...
public class HappyPetsSecurityConfiguration {
    ...
    @Bean
    public HappyPetsUserDetailsService userDetailsService(UserRepository userRepository) {
        return new HappyPetsUserDetailsService(userRepository);
    }
}
